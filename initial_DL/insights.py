...
def main():
	...
	print("LOC PUNT: {}".format(at_least_five(uniquepunt,"uniquepunt")))
	print("LOC LIJN: {}".format(at_least_five(uniquelijn,"uniquelijn")))
	print("LOC BC: {}".format(at_least_five(uniquebc,"uniquebc")))
	print("LOC WATER: {}".format(at_least_five(uniquewater,"uniquewater")))
	print("LOC NONE: {}".format(at_least_five(uniquenone,"uniquenone")))
	print("LOC REGIO: {}".format(at_least_five(uniqueregio,"uniqueregio")))
	print("LOC FICTIEF: {}".format(at_least_five(uniquefictief,"uniquefictief")))
	print("LOC LAND: {}".format(at_least_five(uniqueland,"uniqueland")))
	print("LOC CONT: {}".format(at_least_five(uniquecont,"uniquecont")))
	print("LOC HEELAL: {}".format(at_least_five(uniqueheelal,"uniqueheelal")))
	print("\n")
	print("ORG NONE: {}".format(at_least_five(uniqueorg_none,"uniqueorg_none")))
	print("ORG MISC: {}".format(at_least_five(uniqueorg_misc,"uniqueorg_misc")))
	print("ORG GOV: {}".format(at_least_five(uniquegov,"uniquegov")))
	print("ORG COM: {}".format(at_least_five(uniquecom,"uniquecom")))
	print("----------------------------------------------------------")
	print("\n")
	print("Top ten unique word bigrams in front of NE")
	print("LOC PUNT: {}".format(at_least_five(punt_pre_bi_un,"punt_pre_bi_un")))
	print("LOC LIJN: {}".format(at_least_five(lijn_pre_bi_un,"lijn_pre_bi_un")))
	print("LOC BC: {}".format(at_least_five(bc_pre_bi_un,"bc_pre_bi_un")))
	print("LOC WATER: {}".format(at_least_five(water_pre_bi_un,"water_pre_bi_un")))
	print("LOC NONE: {}".format(at_least_five(none_pre_bi_un,"none_pre_bi_un")))
	print("LOC REGIO: {}".format(at_least_five(regio_pre_bi_un,"regio_pre_bi_un")))
	print("LOC FICTIEF: {}".format(at_least_five(fictief_pre_bi_un,"fictief_pre_bi_un")))
	print("LOC LAND: {}".format(at_least_five(land_pre_bi_un,"land_pre_bi_un")))
	print("LOC CONT: {}".format(at_least_five(cont_pre_bi_un,"cont_pre_bi_un")))
	print("LOC HEELAL: {}".format(at_least_five(heelal_pre_bi_un,"heelal_pre_bi_un")))
	print("\n")
	...
	print("ORG GOV: {}".format(at_least_five(gov_pre_bi_un,"gov_pre_bi_un")))
	print("ORG COM: {}".format(at_least_five(com_pre_bi_un,"com_pre_bi_un")))
	print("----------------------------------------------------------")
	print("\n")
	print("Top ten unique word bigrams after NE")
	print("LOC PUNT: {}".format(at_least_five(punt_post_bi_un,"punt_post_bi_un")))
	print("LOC LIJN: {}".format(at_least_five(lijn_post_bi_un,"lijn_post_bi_un")))
	print("LOC BC: {}".format(at_least_five(bc_post_bi_un,"bc_post_bi_un")))
	print("LOC WATER: {}".format(at_least_five(water_post_bi_un,"water_post_bi_un")))
	print("LOC NONE: {}".format(at_least_five(none_post_bi_un,"none_post_bi_un")))
	print("LOC REGIO: {}".format(at_least_five(regio_post_bi_un,"regio_post_bi_un")))
	print("LOC FICTIEF: {}".format(at_least_five(fictief_post_bi_un,"fictief_post_bi_un")))
	print("LOC LAND: {}".format(at_least_five(land_post_bi_un,"land_post_bi_un")))
	print("LOC CONT: {}".format(at_least_five(cont_post_bi_un,"cont_post_bi_un")))
	print("LOC HEELAL: {}".format(at_least_five(heelal_post_bi_un,"heelal_post_bi_un")))
	print("\n")
	...
	print("ORG GOV: {}".format(at_least_five(gov_post_bi_un,"gov_post_bi_un")))
	print("ORG COM: {}".format(at_least_five(com_post_bi_un,"com_post_bi_un")))
	print("----------------------------------------------------------")
	print("\n")
	print("Top ten unique word bigrams before NE")
	print("LOC PUNT: {}".format(at_least_five(punt_pre_si_un,"punt_pre_si_un")))
	print("LOC LIJN: {}".format(at_least_five(lijn_pre_si_un,"lijn_pre_si_un")))
	print("LOC BC: {}".format(at_least_five(bc_pre_si_un,"bc_pre_si_un")))
	print("LOC WATER: {}".format(at_least_five(water_pre_si_un,"water_pre_si_un")))
	print("LOC NONE: {}".format(at_least_five(none_pre_si_un,"none_pre_si_un")))
	print("LOC REGIO: {}".format(at_least_five(regio_pre_si_un,"regio_pre_si_un")))
	print("LOC FICTIEF: {}".format(at_least_five(fictief_pre_si_un,"fictief_pre_si_un")))
	print("LOC LAND: {}".format(at_least_five(land_pre_si_un,"land_pre_si_un")))
	print("LOC CONT: {}".format(at_least_five(cont_pre_si_un,"cont_pre_si_un")))
	print("LOC HEELAL: {}".format(at_least_five(heelal_pre_si_un,"heelal_pre_si_un")))
	print("\n")
	...
	print("ORG GOV: {}".format(at_least_five(gov_pre_si_un,"gov_pre_si_un")))
	print("ORG COM: {}".format(at_least_five(com_pre_si_un,"com_pre_si_un")))
	print("----------------------------------------------------------")
	print("\n")
	print("Top ten unique word unigrams after NE")
	print("LOC PUNT: {}".format(at_least_five(punt_post_si_un,"punt_post_si_un")))
	print("LOC LIJN: {}".format(at_least_five(lijn_post_si_un,"lijn_post_si_un")))
	print("LOC BC: {}".format(at_least_five(bc_post_si_un,"bc_post_si_un")))
	print("LOC WATER: {}".format(at_least_five(water_post_si_un,"water_post_si_un")))
	print("LOC NONE: {}".format(at_least_five(none_post_si_un,"none_post_si_un")))
	print("LOC REGIO: {}".format(at_least_five(regio_post_si_un,"regio_post_si_un")))
	print("LOC FICTIEF: {}".format(at_least_five(fictief_post_si_un,"fictief_post_si_un")))
	print("LOC LAND: {}".format(at_least_five(land_post_si_un,"land_post_si_un")))
	print("LOC CONT: {}".format(at_least_five(cont_post_si_un,"cont_post_si_un")))
	print("LOC HEELAL: {}".format(at_least_five(heelal_post_si_un,"heelal_post_si_un")))
	print("\n")
	...
	print("ORG GOV: {}".format(at_least_five(gov_post_si_un,"gov_post_si_un")))
	print("ORG COM: {}".format(at_least_five(com_post_si_un,"com_post_si_un")))
	print("----------------------------------------------------------")
